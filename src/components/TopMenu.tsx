...
import { CiBellOn, CiBookmarkCheck, CiChat1, CiLogout, CiMenuBurger, CiSearch, CiShoppingBasket } from 'react-icons/ci';
            ...
            <div className="flex space-x-2">
              ...
              <Link
               ...
               className="p-2 flex items-center justify-center h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
                {
                  (totalItems > 0 ) && (<span className='text-sm text-blue-800 font-bold m-2'>{totalItems}</span>)
                }
